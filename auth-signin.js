...
function initializeAuthScript() {
    console.log('Initializing sign in auth script...');
    initializeAuth();
    checkAuthState();
    console.log('Sign in auth script initialized');
}

// Configurar event listeners
function setupEventListeners() {
    console.log('Setting up sign in event listeners...');
...
function initializeAuth() {
    ...
    console.log('Sign in auth initialized successfully');
}
...
window.addEventListener('firebaseReady', function() {
    console.log('Firebase ready event received in sign in page');
    ...
    console.log('Firebase Auth functions loaded for sign in');
